...
var toggleSitesList = "example.com"; // replace intial values with ones from synced storage
...
chrome.webRequest.onBeforeRequest.addListener(function (details) {
  ...
  urls: ["<all_urls>"]
}, ["blocking"]); // any time that a storage item is update, update the global scope varaibles
